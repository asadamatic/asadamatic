...
class ValueTicker extends StatelessWidget {
  const ValueTicker({Key? key, required this.valueType, required this.screen}) : super(key: key);
        ...
        builder: (_homeController) => Padding(
              ...
              child: Text(
                ...
                _homeController.githubRepoCount
                        .toString()
                        .padLeft(2, '0') : AppConstants.commercialProjects.toString(),
                style: textTheme,
                textAlign: screen == Screen.small ? TextAlign.center : TextAlign.start,
              ),
            ));
  }
}
